...
class BusinessDayImmutableTest extends TestCase
{
    ...
    public function testNextBusinessDay()
    {
        ...
        self::assertNotSame($date, $date->nextBusinessDay());
        self::assertSame('17/04/2018', $date->nextBusinessDay()->format('d/m/Y'));
        $date = $carbon::parse('2018-11-11 12:00:00');
        self::assertNotSame($date, $date->nextBusinessDay());
        self::assertSame('12/11/2018', $date->nextBusinessDay()->format('d/m/Y'));
    }
    ...
    public function testCurrentOrNextBusinessDay()
    {
        ...
        $date = $carbon::parse('2018-11-11 12:00:00');
        self::assertNotSame($date, $date->currentOrNextBusinessDay());
        self::assertSame('12/11/2018', $date->currentOrNextBusinessDay()->format('d/m/Y'));
    }
    ...
    public function testPreviousBusinessDay()
    {
        ...
        $date = $carbon::parse('2018-04-16 12:00:00');
        self::assertNotSame($date, $date->previousBusinessDay());
        self::assertSame('13/04/2018', $date->previousBusinessDay()->format('d/m/Y'));
        $date = $carbon::parse('2018-11-11 12:00:00');
        self::assertNotSame($date, $date->previousBusinessDay());
        self::assertSame('09/11/2018', $date->previousBusinessDay()->format('d/m/Y'));
    }
    ...
    public function testCurrentOrPreviousBusinessDay()
    {
        ...
        $date = $carbon::parse('2018-11-11 12:00:00');
        self::assertNotSame($date, $date->currentOrPreviousBusinessDay());
        self::assertSame('09/11/2018', $date->currentOrPreviousBusinessDay()->format('d/m/Y'));
    }
    ...
    public function testAddBusinessDay()
    {
        ...
        $date = $carbon::parse('2018-11-11 12:00:00');
        self::assertNotSame($date, $date->addBusinessDays(17));
        self::assertSame('04/12/2018', $date->addBusinessDays(17)->format('d/m/Y'));
    }
    ...
    public function testSubBusinessDay()
    {
        ...
        $date = $carbon::parse('2018-11-11 12:00:00');
        self::assertNotSame($date, $date->subBusinessDays(17));
        self::assertSame('17/10/2018', $date->subBusinessDays(17)->format('d/m/Y'));
    }
    ...
    public function testSubtractBusinessDay()
    {
        ...
        $date = $carbon::parse('2018-11-11 12:00:00');
        self::assertNotSame($date, $date->subtractBusinessDays(17));
        self::assertSame('17/10/2018', $date->subtractBusinessDays(17)->format('d/m/Y'));
    }
